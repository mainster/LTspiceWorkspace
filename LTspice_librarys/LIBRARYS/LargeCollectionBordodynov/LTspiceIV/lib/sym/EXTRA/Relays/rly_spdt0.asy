...
WINDOW 38 8 127 Center 0
WINDOW 0 -16 -80 Left 0

SYMATTR Value RLY_SPDT0
SYMATTR SpiceModel ..\sym\EXTRA\Relays\relay.lib
SYMATTR Prefix X
SYMATTR SpiceLine VNOM=5  RCOIL=500  VON=0.8  VOFF=0.4 RON=0.1  ROFF=1G  COFF=1f  LSER=1f  CCOUP=1f
SYMATTR SpiceLine2 TON=1m TOFF=1m  LCOIL=10m CCOIL=1f
