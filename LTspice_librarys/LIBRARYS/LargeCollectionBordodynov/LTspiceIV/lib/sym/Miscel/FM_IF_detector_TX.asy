...
LINE Normal 16 8 16 113
LINE Normal 16 8 48 8
RECTANGLE Normal 144 112 -112 -96 3
...
SYMATTR Prefix X
SYMATTR Description IF detector transformer for radios, with centre-tapped secondary.
SYMATTR SpiceModel if-centre-tap
