...
SYMATTR Value LT1671x
SYMATTR Prefix X
SYMATTR SpiceModel LT1671x.sub
SYMATTR Value2 LT1671x
SYMATTR Description 60ns, Low Power, Single Supply, Ground-Sensing Comparator, Warning: model is modified!
PIN -128 -96 LEFT 8
PINATTR PinName V+
