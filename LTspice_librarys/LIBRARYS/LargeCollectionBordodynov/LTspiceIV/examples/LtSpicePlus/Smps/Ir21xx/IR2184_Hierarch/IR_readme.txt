...
model used within your top level schematic must have a copy of its 
individual symbol and schematic (i.e. one .asy file and one .asc 
file per driver) co-located in the same folder with your schematic. 
...
3) Choose the folder where your working schematic currently is 
   located and the IR driver symbol should now appear in the 
