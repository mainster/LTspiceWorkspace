function APLL_PI_VCO_Kennlinie
%------------------------------------------------------------------------
% APLL_PI_VCO_Kennlinie
%
% Darstellung der Abstimmkennlinie und der Steilheit des VCOs, der
% in der Simulation APLL_PI_Settling.sch verwendet wird.
%
% Simulation: PLL/APLL_PI_VCO_Kennlinie.sch
%------------------------------------------------------------------------
% (c) Tietze/Schenk/Gamm 2012
%------------------------------------------------------------------------

% Simulationsdaten einlesen
datei='..\PLL\APLL_PI_VCO_Kennlinie.dat';
...
xlabel('UA [V]');
ylabel('f [MHz]');
title('APLL PI VCO Kennlinie: Kennlinie des VCOs');
subplot(1,2,2);
...
xlabel('UA [V]');
ylabel('K [MHz/V]');
title('APLL PI VCO Kennlinie: Steilheit des VCOs');
