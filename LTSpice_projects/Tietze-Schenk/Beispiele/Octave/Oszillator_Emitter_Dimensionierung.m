function [c1,c2,c3,q]=Oszillator_Emitter_Dimensionierung(m)
%------------------------------------------------------------------------
% Oszillator_Emitter_Dimensionierung(m)
%
% Dimensionierung eines Colpitts-Oszillators in Emitterschaltung
%
% Parameter:
%   m - relative Groesse des Transistors
%
% Simulation: Oszillatoren/Colpitts/Emitter.sch
%------------------------------------------------------------------------
...
% (siehe Simulation Oszillatoren/Stromquelle/StromquelleP.sch)
ro=180;
co=2.55e-12;
...
g=m*[ 1/rb+1/rbe -1/rbe        0     0                   0         -1/rb     0     ;
      -1/rbe-gm  1/rbe+gm+1/re 0     0                   0         0         0     ;
      gm         -gm           1/rc  -1/rc               0         0         0     ;
      0          0             -1/rc 1/rc+1/ro+ 1/(m*rp) -1/(m*rp) 0         -1/ro ;
      0          0             0     -1/(m*rp)           1/(m*rp)  0         0     ;
      -1/rb      0             0     0                   0         1/rb      0     ;
      0          0             0     -1/ro               0         0         1/ro  ];
