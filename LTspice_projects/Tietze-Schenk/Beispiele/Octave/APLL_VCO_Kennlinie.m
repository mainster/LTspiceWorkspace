function APLL_VCO_Kennlinie
%------------------------------------------------------------------------
% APLL_VCO_Kennlinie
%
% Darstellung der Abstimmkennlinie und der Steilheit des VCOs, der
% in der Simulation APLL_Settling.sch verwendet wird.
%
% Simulation: PLL/APLL_VCO_Kennlinie.sch
%------------------------------------------------------------------------
% (c) Tietze/Schenk/Gamm 2012
%------------------------------------------------------------------------

% Simulationsdaten einlesen
datei='..\PLL\APLL_VCO_Kennlinie.dat';
...
xlabel('UA [V]');
ylabel('f [MHz]');
title('APLL VCO Kennlinie: Kennlinie des VCOs');
subplot(1,2,2);
...
xlabel('UA [V]');
ylabel('K [MHz/V]');
title('APLL VCO Kennlinie: Steilheit des VCOs');
